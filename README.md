...
| --- | --- | --- |
| `one.sh` | Guided VPS setup | `BFS_VER=1.3.11; curl -fsSL https://fastly.jsdelivr.net/gh/bitsfactor/scripts@v$BFS_VER/one.sh | BFS_VER=$BFS_VER bash` |
| `env.sh` | Install dev tools | `BFS_VER=1.3.11; curl -fsSL https://fastly.jsdelivr.net/gh/bitsfactor/scripts@v$BFS_VER/env.sh | BFS_VER=$BFS_VER bash` |
| `git.sh` | Set up GitHub SSH keys | `BFS_VER=1.3.11; curl -fsSL https://fastly.jsdelivr.net/gh/bitsfactor/scripts@v$BFS_VER/git.sh | BFS_VER=$BFS_VER bash` |
| `claude.sh` | Install and configure Claude Code | `BFS_VER=1.3.11; curl -fsSL https://fastly.jsdelivr.net/gh/bitsfactor/scripts@v$BFS_VER/claude.sh | BFS_VER=$BFS_VER bash` |
| `codex.sh` | Install and configure Codex | `BFS_VER=1.3.11; curl -fsSL https://fastly.jsdelivr.net/gh/bitsfactor/scripts@v$BFS_VER/codex.sh | BFS_VER=$BFS_VER bash` |
| `pytools.sh` | Install Python CLI tools | `BFS_VER=1.3.11; curl -fsSL https://fastly.jsdelivr.net/gh/bitsfactor/scripts@v$BFS_VER/pytools.sh | BFS_VER=$BFS_VER bash` |
...
```bash
BFS_VER=1.3.11; curl -fsSL https://fastly.jsdelivr.net/gh/bitsfactor/scripts@v$BFS_VER/codex.sh | BFS_VER=$BFS_VER bash
```
