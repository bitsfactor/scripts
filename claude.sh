...
echo -e "${CYAN}Select an option:${NC}"
echo -e "  ${GREEN}1)${NC} Install / Update Claude Code  - install or upgrade Claude Code"
echo -e "  ${GREEN}2)${NC} Set API                       - write Anthropic API settings"
...
echo -e "  ${RED}5)${NC} Uninstall Claude Code          - remove Claude Code and related config"
